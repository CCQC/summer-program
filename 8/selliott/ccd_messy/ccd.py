...
class CCD(object):
  ...
  def update_amplitudes(self,t):
    ...
    P = np.einsum('akic,jkbc->ijab',g[v,o,o,v],t)
    HNT2 += P - P.transpose((1,0,2,3)) - P.transpose((0,1,3,2)) + P.transpose((1,0,3,2))


    P = np.einsum('klcd,ijac,klbd->ijab',g[o,o,v,v],t,t)
    HNT2T2 =  -1/2. * (P - P.transpose((0,1,3,2)) )
    P = np.einsum('klcd,ikab,jlcd->ijab',g[o,o,v,v],t,t)
